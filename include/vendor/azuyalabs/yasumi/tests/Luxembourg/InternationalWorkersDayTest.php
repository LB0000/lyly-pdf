...
/**
 * Class containing tests for International Workers' Day (i.e. Labour Day) in Luxembourg.
 */
class InternationalWorkersDayTest extends LuxembourgBaseTestCase implements HolidayTestCase
{
    /**
