...
/**
 * Class containing tests for New Years Day in Appenzell Ausserrhoden (Switzerland).
 */
class NewYearsDayTest extends AppenzellAusserrhodenBaseTestCase implements HolidayTestCase
{
    /**
