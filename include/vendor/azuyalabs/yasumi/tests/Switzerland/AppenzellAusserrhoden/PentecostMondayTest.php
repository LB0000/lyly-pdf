...
/**
 * Class for testing Pentecost Monday in Appenzell Ausserrhoden (Switzerland).
 */
class PentecostMondayTest extends AppenzellAusserrhodenBaseTestCase implements HolidayTestCase
{
    /**
