...
/**
 * Class for testing Christmas in Appenzell Ausserrhoden (Switzerland).
 */
class ChristmasDayTest extends AppenzellAusserrhodenBaseTestCase implements HolidayTestCase
{
    /**
