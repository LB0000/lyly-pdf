...
/**
 * Class for testing the day of Immaculate Conception in Zug (Switzerland).
 */
class ImmaculateConceptionTest extends ZugBaseTestCase implements HolidayTestCase
{
    /**
