...
/**
 * Class for testing Pentecost Monday in Basel Landschaft (Switzerland).
 */
class PentecostMondayTest extends BaselLandschaftBaseTestCase implements HolidayTestCase
{
    /**
