...
/**
 * Class for testing St. Stephen's Day in Basel Landschaft (Switzerland).
 */
class StStephensDayTest extends BaselLandschaftBaseTestCase implements HolidayTestCase
{
    /**
