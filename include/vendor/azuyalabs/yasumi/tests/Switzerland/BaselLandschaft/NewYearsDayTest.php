...
/**
 * Class containing tests for New Years Day in Basel Landschaft (Switzerland).
 */
class NewYearsDayTest extends BaselLandschaftBaseTestCase implements HolidayTestCase
{
    /**
