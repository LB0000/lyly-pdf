...
/**
 * Class containing tests for Easter Monday in Basel Landschaft (Switzerland).
 */
class EasterMondayTest extends BaselLandschaftBaseTestCase implements HolidayTestCase
{
    /**
