...
/**
 * Class for testing the day of Immaculate Conception in Schwyz (Switzerland).
 */
class ImmaculateConceptionTest extends SchwyzBaseTestCase implements HolidayTestCase
{
    /**
