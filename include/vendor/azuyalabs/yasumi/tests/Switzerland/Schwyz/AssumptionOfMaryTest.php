...
/**
 * Class for testing the day of the Assumption of Mary in Schwyz (Switzerland).
 */
class AssumptionOfMaryTest extends SchwyzBaseTestCase implements HolidayTestCase
{
    /**
