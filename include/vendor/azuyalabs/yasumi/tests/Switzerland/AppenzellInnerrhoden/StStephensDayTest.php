...
/**
 * Class for testing St. Stephen's Day in Appenzell Innerrhoden (Switzerland).
 */
class StStephensDayTest extends AppenzellInnerrhodenBaseTestCase implements HolidayTestCase
{
    /**
