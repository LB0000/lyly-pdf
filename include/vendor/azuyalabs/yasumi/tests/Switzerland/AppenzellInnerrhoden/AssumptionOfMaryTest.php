...
/**
 * Class for testing the day of the Assumption of Mary in Appenzell Innerrhoden (Switzerland).
 */
class AssumptionOfMaryTest extends AppenzellInnerrhodenBaseTestCase implements HolidayTestCase
{
    /**
