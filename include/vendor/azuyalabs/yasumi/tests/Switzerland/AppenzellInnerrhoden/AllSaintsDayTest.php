...
/**
 * Class for testing All Saints' Day in Appenzell Innerrhoden (Switzerland).
 */
class AllSaintsDayTest extends AppenzellInnerrhodenBaseTestCase implements HolidayTestCase
{
    /**
