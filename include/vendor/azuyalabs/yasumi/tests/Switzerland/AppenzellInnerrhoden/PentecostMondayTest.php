...
/**
 * Class for testing Pentecost Monday in Appenzell Innerrhoden (Switzerland).
 */
class PentecostMondayTest extends AppenzellInnerrhodenBaseTestCase implements HolidayTestCase
{
    /**
