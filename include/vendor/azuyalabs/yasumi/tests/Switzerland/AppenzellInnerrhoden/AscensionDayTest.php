...
/**
 * Class for testing Ascension Day in Appenzell Innerrhoden (Switzerland).
 */
class AscensionDayTest extends AppenzellInnerrhodenBaseTestCase implements HolidayTestCase
{
    /**
