...
/**
 * Class for testing Christmas in Appenzell Innerrhoden (Switzerland).
 */
class ChristmasDayTest extends AppenzellInnerrhodenBaseTestCase implements HolidayTestCase
{
    /**
