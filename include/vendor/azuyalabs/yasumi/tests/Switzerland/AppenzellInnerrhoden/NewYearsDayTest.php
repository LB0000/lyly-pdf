...
/**
 * Class containing tests for New Years Day in Appenzell Innerrhoden (Switzerland).
 */
class NewYearsDayTest extends AppenzellInnerrhodenBaseTestCase implements HolidayTestCase
{
    /**
