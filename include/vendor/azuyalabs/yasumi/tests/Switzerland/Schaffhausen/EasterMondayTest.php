...
/**
 * Class containing tests for Easter Monday in Schaffhausen (Switzerland).
 */
class EasterMondayTest extends SchaffhausenBaseTestCase implements HolidayTestCase
{
    /**
