...
/**
 * Class for testing the day of Immaculate Conception in Uri (Switzerland).
 */
class ImmaculateConceptionTest extends UriBaseTestCase implements HolidayTestCase
{
    /**
