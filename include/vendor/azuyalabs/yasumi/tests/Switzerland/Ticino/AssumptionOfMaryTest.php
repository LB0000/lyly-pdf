...
/**
 * Class for testing the day of the Assumption of Mary in Ticino (Switzerland).
 */
class AssumptionOfMaryTest extends TicinoBaseTestCase implements HolidayTestCase
{
    /**
