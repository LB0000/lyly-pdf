...
/**
 * Class for testing All Saints' Day in Ticino (Switzerland).
 */
class AllSaintsDayTest extends TicinoBaseTestCase implements HolidayTestCase
{
    /**
