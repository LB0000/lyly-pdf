...
/**
 * Class containing tests for Easter Monday in Ticino (Switzerland).
 */
class EasterMondayTest extends TicinoBaseTestCase implements HolidayTestCase
{
    /**
