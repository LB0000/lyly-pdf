...
/**
 * Class for testing Ascension Day in Ticino (Switzerland).
 */
class AscensionDayTest extends TicinoBaseTestCase implements HolidayTestCase
{
    /**
