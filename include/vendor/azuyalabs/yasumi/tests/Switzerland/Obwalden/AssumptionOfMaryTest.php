...
/**
 * Class for testing the day of the Assumption of Mary in Obwalden (Switzerland).
 */
class AssumptionOfMaryTest extends ObwaldenBaseTestCase implements HolidayTestCase
{
    /**
