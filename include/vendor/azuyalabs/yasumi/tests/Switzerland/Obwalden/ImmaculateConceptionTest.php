...
/**
 * Class for testing the day of Immaculate Conception in Obwalden (Switzerland).
 */
class ImmaculateConceptionTest extends ObwaldenBaseTestCase implements HolidayTestCase
{
    /**
