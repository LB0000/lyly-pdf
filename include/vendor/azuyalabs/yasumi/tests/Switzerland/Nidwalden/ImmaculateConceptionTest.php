...
/**
 * Class for testing the day of Immaculate Conception in Nidwalden (Switzerland).
 */
class ImmaculateConceptionTest extends NidwaldenBaseTestCase implements HolidayTestCase
{
    /**
