...
/**
 * Class for testing the day of Immaculate Conception in Lucerne (Switzerland).
 */
class ImmaculateConceptionTest extends LucerneBaseTestCase implements HolidayTestCase
{
    /**
