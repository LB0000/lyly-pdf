...
/**
 * Class for testing Youth Day in South Africa.
 *
 ...
 */
class YouthDayTest extends SouthAfricaBaseTestCase implements HolidayTestCase
{
    /**
     * The name of the holiday to be tested.
     */
    public const HOLIDAY = 'youthDay';
