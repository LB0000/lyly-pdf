...
/**
 * Class for testing Human Rights Day in South Africa.
 *
 ...
 */
class HumanRightsDayTest extends SouthAfricaBaseTestCase implements HolidayTestCase
{
    /**
     * The name of the holiday to be tested.
     */
    public const HOLIDAY = 'humanRightsDay';
