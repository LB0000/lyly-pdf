...
/**
 * Class for testing National Women's Day in South Africa.
 *
 ...
 */
class NationalWomensDayTest extends SouthAfricaBaseTestCase implements HolidayTestCase
{
    /**
     * The name of the holiday to be tested.
     */
    public const HOLIDAY = 'nationalWomensDay';
