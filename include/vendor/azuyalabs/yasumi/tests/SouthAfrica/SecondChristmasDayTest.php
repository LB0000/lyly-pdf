...
/**
 * Class for testing the Day of Goodwill in South Africa.
 *
 ...
 */
class SecondChristmasDayTest extends SouthAfricaBaseTestCase implements HolidayTestCase
{
    /**
