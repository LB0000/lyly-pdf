...
/**
 * Class for testing Family Friday in South Africa.
 *
 ...
 */
class FamilyDayTest extends SouthAfricaBaseTestCase implements HolidayTestCase
{
    /**
     * The name of the holiday to be tested.
     */
    public const HOLIDAY = 'familyDay';
