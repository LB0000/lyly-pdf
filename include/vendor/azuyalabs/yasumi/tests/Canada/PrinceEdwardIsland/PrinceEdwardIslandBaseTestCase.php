...
/**
 * Base class for test cases of the Prince Edward Island holiday provider.
 */
abstract class PrinceEdwardIslandBaseTestCase extends CanadaBaseTestCase
{
    use YasumiBase;

    /** Name of the region (e.g. country / state) to be tested. */
    public const REGION = 'Canada\PrinceEdwardIsland';
