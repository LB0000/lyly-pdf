...
/**
 * Base class for test cases of the Ontario holiday provider.
 */
abstract class OntarioBaseTestCase extends CanadaBaseTestCase
{
    use YasumiBase;

    /** Name of the region (e.g. country / state) to be tested. */
    public const REGION = 'Canada\Ontario';
