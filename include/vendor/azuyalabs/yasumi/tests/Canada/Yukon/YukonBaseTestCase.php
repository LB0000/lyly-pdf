...
/**
 * Base class for test cases of the Yukon holiday provider.
 */
abstract class YukonBaseTestCase extends CanadaBaseTestCase
{
    use YasumiBase;

    /** Name of the region (e.g. country / state) to be tested. */
    public const REGION = 'Canada\Yukon';

    /** Timezone in which this provider has holidays defined. */
    public const TIMEZONE = 'America/Whitehorse';
