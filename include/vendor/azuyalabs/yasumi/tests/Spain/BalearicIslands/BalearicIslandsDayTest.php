...
/**
 * Class for testing the Day of the Balearic Islands in the Balearic Islands (Spain).
 */
class BalearicIslandsDayTest extends BalearicIslandsBaseTestCase implements HolidayTestCase
{
    /**
