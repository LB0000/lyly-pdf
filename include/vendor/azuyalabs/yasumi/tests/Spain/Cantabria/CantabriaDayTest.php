...
/**
 * Class for testing Cantabria Day in Cantabria (Spain).
 */
class CantabriaDayTest extends CantabriaBaseTestCase implements HolidayTestCase
{
    /**
