...
/**
 * Class for testing Western Australia Day in Western Australia (Australia)..
 */
class WesternAustraliaDayTest extends WesternAustraliaBaseTestCase implements HolidayTestCase
{
    /**
